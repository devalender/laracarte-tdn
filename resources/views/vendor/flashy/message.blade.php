...
.flashy {
    ...
    border-radius: 4px;
    font-weight: 400;
    position: fixed;/*definir les positions du message*/
    bottom: 20px;/*en bas, top c'est en haut*/
    right: 20px;/* adroite*/ /*metrre un truc au dessus de tous les elements z-index:999999999999999;*/
    font-size: 16px;
    color: #fff;
}
